        ...
        case "JANTARY":
          ...
          switch (bet.subBetType) {
            ...
            case "OPEN":
              ...
              winAmount = isWin ? bet.amount * 9.8 : 0; // 1:9.8 ratio for open (10 ka 98)
              break;
          }
          break;
        // case "CROSSING":
